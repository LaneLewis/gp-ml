    ...
    def fit(self,Z,X_train:torch.Tensor,encoder_optimizer:object=None,decoder_optimizer:object=None,epochs=100,
        ...
        for epoch in range(epochs):
            ...
            for (batch_X,) in tqdm(batched_X_train,desc=f"epoch: {epoch}",colour="cyan"):
                ...
                #computes the loss
                indiv_losses,indiv_kls,indiv_lls = approx_elbo_loss(self.taus,batch_X,self.encoder_model.forward,self.decoder_model.forward,self.R,self.kernel_matrices,samples=approx_elbo_loss_samples,loss_hyper=loss_hyperparameter)
